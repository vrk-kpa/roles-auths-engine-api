...
public interface EngineResource {
	...
	@Produces(MediaType.APPLICATION_JSON)
	public Map<String, Object> getDelegateWithIssue(@PathParam("personId") String personId, @QueryParam("industry") String industry, @PathParam("service") String service, @PathParam("issue") String issue, @PathParam("enduserId") String endUserId);

	@GET
	@Path("/authorization/{service}/{enduserId}/{delegateId}/{principalId}")
	@Produces(MediaType.APPLICATION_JSON)
	public Map<String, Object> getAuthorization(@PathParam("delegateId") String delegateId, @PathParam("principalId") String principalId, @QueryParam("industry") String industry, @PathParam("service") String service, @PathParam("enduserId") String endUserId);
